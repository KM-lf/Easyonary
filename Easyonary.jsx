...
export default function EasyDictionary() {
  ...
  const search = async (word) => {
    ...
    try {
      ...
      setError("Couldn't find that word. Try another!");
    } finally {
      setLoading(false);
    }
  };
...
const styles = {
  ...
  wordText: {
    fontFamily: "'Playfair Display', serif",
    fontSize: "36px", fontWeight: "700", color: "#f2f0ff",
    lineHeight: 1.1,
  },
  pos: {
    marginTop: "6px",
  ...
  phoneticLabel: {
    ...
    color: "#ff8c5a", letterSpacing: "0.1em",
  ...
  phoneticNote: {
    marginTop: "8px", fontSize: "12px", color: "#7c7b8e",
  },
  ...
  sectionLabel: {
    ...
    color: "#6b6a80", letterSpacing: "0.12em",
    textTransform: "uppercase", marginBottom: "8px",
  },
